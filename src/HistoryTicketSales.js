...
export default function HistoryTicketSales() {
    ...
    useEffect(() => {
        ...
        axios.get(backendUrl+"/salesticketshist/"+user, {
            headers: {
    ...
    function handleViewTicket(id) {
        ...
        window.location.href = "/workflowtlfe/viewhistoryticketsales";
    }
    ...
    const handleLogout = () => {
        ...
        window.location.href = "/workflowtlfe/saleslogin";
    };

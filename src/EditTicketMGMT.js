...
export default function EditTicketMGMT() {
  ...
  const handleReject = async () => {
    ...
    swal({
      ...
      .then(async (willDelete) => {
        ...
        if (willDelete) {
          rejectreason = "Reject by management"
      ...
      <AppBar position="static">
        <Toolbar>
          <Typography variant="h6" className={classes.title}>
            Capital Market Director ({userid})
          </Typography>
          <div>
      ...
      <Grid container spacing={1} margin={1} border={1}>
        ...
        <Grid item xs={12}>
          <Grid container justifyContent="space-between">
            ...
            <Grid item>
              <Button className={classes.button} variant="contained" color="default" onClick={(e) => handleApprove(e)}>Approve</Button>
            </Grid>
          </Grid>
        </Grid>
        {showTable && (
